...
resourcegroup_name = 'rng'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'rng'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.RowKey = '002'
car.make = 'Volkswagaon'
car.model = 'Beetle'
car.year = 2017
car.color = 'Orange'
car.cost = 25000
table_service.insert_entity('itemstable', car)
print('Created entry for Volkswagon Beetle...')
...
print('Created entry for Philz Small Cup Coffee...\n')
